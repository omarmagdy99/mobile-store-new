								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
                                            ...
                                            {{-- get sales data  --}}
                                            <span style="display: none">{{$countSales=\App\sales_invoice::get()->count(),$subtotalSales=0,$sales_data=\App\sales_invoice::get()}}
                                            ...
                                            {{-- get sales data  --}}
                                            {{-- get product data  --}}
                                            <span style="display: none">{{$countProduct=\App\product::get()->count(),$subtotalProduct=0,$product_data=\App\product::get()}}
                                            ...
                                            {{-- get user data  --}}
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format($subtotalPurchases,1)}}</h4>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											...
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format($subtotalSales,1)}}</h4>
						...
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format($subtotalProduct,1)}}</h4>
