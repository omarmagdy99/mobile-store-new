...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Sales</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    SalesUpdate</span>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($sales_invoices_details as $item)
                                        <tr class="td-<?php echo $i; ?>">
                                            ...
                                            <td><a class="btn btn-sm btn-danger delRow"
                                                    data-num="td-<?php echo $i; ?>"><input
                                                        type="hidden" class="status" name="status[]" value="unDelete"><i
                                                        class="las la-trash "></i></a> <a
                                                    class="btn btn-sm btn-info updateRow"
                                                    data-num="td-<?php echo $i; ?>"><i
                                                        class="las la-pen"></i></a>
                                                <a class="btn btn-sm btn-primary doneUpdate"
                                                    data-num="td-<?php echo $i; ?>"
                                                    data-i="<?php echo $i; ?>"><i
        ...
        $('.addVal').click(function(e) {
            ...
            if (!$('#product_name').val() == '' && !$('#price').val() == '' && !$('#quantity').val() == '') {
                ...
                $('tbody').append(
                    ...
                    '" name="product_name[]"><input type="hidden" value="' + $product_id +
                    '" name="product_id[]"></td> ' +
