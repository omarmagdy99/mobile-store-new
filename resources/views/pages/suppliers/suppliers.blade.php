                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="modal-effect btn btn-sm btn-info btn_update" data-effect="effect-scale"
                                        data-toggle="modal" href="#modaldemo6" title="Update"
                                        data-id="{{ $supplier_data->id }}" data-name="{{ $supplier_data->name }} "
                                        data-s_company="{{ $supplier_data->company_name }}"
                                        data-phone="{{ $supplier_data->phone }}"><i class="las la-pen fa-2x"></i></a>
                                    {{-- update زرار ال  --}}
                                    ...
                                    <a class="modal-effect btn btn-sm btn-danger btn_delete" data-effect="effect-scale"
                                        data-toggle="modal" href="#modaldemo7" data-id="{{ $supplier_data->id }}"
