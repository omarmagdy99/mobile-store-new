								...
								<div class="card-body">
									...
									<div class="row mg-t-20">
										...
										<div class="col-md">
											...
											<p class="invoice-info-row"><span>barcode</span> <span>{{$reportProduct->barcode}}</span></p>
											<p class="invoice-info-row"><span>product name</span> <span>{{$reportProduct->product_name}}</span></p>
											<p class="invoice-info-row"><span>create Date:</span> <span>{{$reportProduct->created_at->format('d-m-Y')}}</span></p>
											<p class="invoice-info-row"><span>update Date:</span> <span>{{$reportProduct->updated_at->format('d-m-Y')}}</span></p>
										</div>
									</div>
										...
										<table class="table table-invoice border text-md-nowrap mb-0">
											...
											<tbody>
												...
												<tr>
													...
													<td class="tx-right">${{number_format($reportProduct->quantity*$reportProduct->sale_price) }}</td>
												</tr>
