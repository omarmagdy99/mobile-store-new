...
@section('content')
    ...
    <div class="alert alert-outline-danger mg-b-0" role="alert">
     ...
     <strong>Oh snap!</strong> Change a few things up and try submitting again.
                            ...
                            <div class="clipboard-icon" data-clipboard-target="#alert001"><i class="las la-clipboard"></i>
                            </div>
                        </figure>
                        <!-- End Prism Precode -->
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            ...
                            <div class="alert alert-success" role="alert">
                                This is a success alert with <a href="#" class="alert-link">an example link</a>. Give it a
                                click if you like.
                            </div>
                            <div class="alert alert-danger" role="alert">
                                This is a danger alert with <a href="#" class="alert-link">an example link</a>. Give it a
                                click if you like.
                            </div>
                            <div class="alert alert-warning" role="alert">
                                This is a warning alert with <a href="#" class="alert-link">an example link</a>. Give it a
                                click if you like.
                            </div>
                            <div class="alert alert-info" role="alert">
            ...
            <div class="card custom-card" id="additional-alerts">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Alerts can also contain additional HTML elements like headings,
            ...
            <div class="card custom-card" id="dismiss-alerts">
                <div class="card-body">
                    <div>
                        ...
                        <p class="text-muted card-sub-title">Using the alert JavaScript plugin, it’s possible to dismiss any
                            alert inline.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
