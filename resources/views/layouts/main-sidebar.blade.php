		...
		<aside class="app-sidebar sidebar-scroll">
			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						<a class="side-menu__item" href="sales"><i class="typcn typcn-shopping-cart "></i><span class="side-menu__label">المبيعات</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="Purchases"><i class="typcn typcn-shopping-cart "></i><span class="side-menu__label">المشتريات</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="products"><i class="typcn typcn-shopping-cart "></i><span class="side-menu__label">المنتجات</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M19 5H5v14h14V5zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z" opacity=".3"/><path d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z"/></svg><span class="side-menu__label">الفئات و الاقسام</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="brands">الفئات </a></li>
							<li><a class="slide-item" href="categories">الاقسام</a></li>
						</ul>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="Employees"><i class="typcn typcn-shopping-cart "></i><span class="side-menu__label">العاملين</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="Expenses"><i class="typcn typcn-shopping-cart "></i><span class="side-menu__label">المصروفات</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="Reports"><i class="typcn typcn-shopping-cart "></i><span class="side-menu__label">التقارير</span></a>
					</li>
					<li class="slide">
						<a class="side-menu__item" href="{{ url('/' . $page='icons') }}"><i class="typcn typcn-shopping-cart "></i><span class="side-menu__label">icon</span></a>
					</li>
					<li class="slide">
