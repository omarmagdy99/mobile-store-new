			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='') }}">Products Reports</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='') }}">Invoices Reports</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='') }}">Customers Reports</a></li>
