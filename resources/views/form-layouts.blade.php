                            ...
                            <div class="modal-content">
                                <div class="modal-body pd-sm-40">
                                    ...
                                    <div class="form-group mg-b-25">
                                        ...
                                        <label class="ckbox"><input checked type="checkbox"><span class="tx-13">Yes, I want
                                                to receive email from your newsletter.</span></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="pos-relative">
                                        ...
                                        <div class="d-flex pos-absolute t-5 r-10"><img alt="" class="wd-30 mg-r-5"
                                                src="{{ URL::asset('assets/img/visa.png') }}"> <img alt="" class="wd-30"
                                ...
                                <div class="form-group">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-sm-3 mg-t-20 mg-sm-t-0">
                                            <label class="main-content-label tx-11 tx-medium tx-gray-600">CVC</label> <input
                                                class="form-control" required="" type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group mg-b-20">
                                    <label class="ckbox"><input checked type="checkbox"><span class="tx-13">Save my card for
